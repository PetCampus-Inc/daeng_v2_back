...
- 코드 내 설명 주석(TODO 제외)을 남기지 않는다. 식별자와 구조만으로 의도가 파악되게 쓴다. 변수·필드·컬럼명에도 약어를 쓰지 않는다 — 예외와 근거는 [`docs/conventions/code-style.md`](docs/conventions/code-style.md)를 따른다.
