> 생성: 2026-07-28 15:00 · 최종 수정: 2026-08-04 17:37
...
`api/`, `database/`, `integrations/`, `operations/`의 인벤토리 내용을 그대로 복제하지 않는다. 이번 티켓의 작업 범위, 제외 범위, 참조한 판정, 구현 중 바뀐 결정만 계획 문서에 남긴다.
