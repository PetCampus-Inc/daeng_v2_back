> 생성: 2026-07-28 15:04 · 최종 수정: 2026-08-30 20:11

# API 명세서 (Notion) 연동 규칙

API 명세서는 코드 저장소가 아니라 Notion 데이터베이스에서 관리한다. 이 문서는 어떤 AI 도구를 쓰든 동일한 방식으로 그 데이터베이스에 페이지를 생성/수정하는 방법을 정의한다. [`000-common.md`](../workflows/000-common.md) 1단계에서 API 계약 영향을 판정하고 5단계에서 갱신·확인할 때, API 추가·변경이면 이 규칙을 따른다.
