> 생성: 2026-09-02 19:24 · 최종 수정: 2026-09-03 13:20
...
| `docs/domains/pet.md` | 갱신 | 견종 기준 데이터 소유·식별자·노출 순서·검색 규칙·공개 API를 신규 추가 (커밋 `6198768`). 이후 확정된 검색 공백 무시 규칙과 permitAll 인증 정책이 누락돼 있던 것을 발견해 추가 반영 |
