> 생성: 2026-08-31 01:05 · 최종 수정: 2026-08-31 01:40
...
- **공통 절차 선형성 보강** — `000-common.md`에 `단계 한눈에 보기` 표와 5단계 리뷰 반복 종료 조건을 넣었다가 사용자 요청으로 되돌렸다. 5단계 골격과 유형별 결합 방식은 그대로 두기로 한다.
...
- 2026-08-31 — 공통 절차 선형성 보강은 범위에서 제외하기로 확정. `000-common.md`에는 2단계 미결 질문 점검 조건만 남긴다.
